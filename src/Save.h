...
public:
    ...
    // 将 src_index 角色数据复制到 dst_index（用于「影子队友」等扩展），并更新姓名索引；不调用 makeMapsAndRepairID
    void cloneRoleFromTo(int dst_index, int src_index, const std::string& new_name, const std::string& new_nick);
