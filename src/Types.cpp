...
#define GET_VALUE_INT(v, default_v) \
    ...
    GET_VALUE_INT(Level, 99);
    GET_VALUE_INT(HP, 9999);
    GET_VALUE_INT(MP, 9999);
    GET_VALUE_INT(PhysicalPower, 100);

    GET_VALUE_INT(Poison, 200);

    GET_VALUE_INT(Attack, 999);
    GET_VALUE_INT(Defence, 999);
    GET_VALUE_INT(Speed, 200);

    GET_VALUE_INT(Medicine, 200);
    GET_VALUE_INT(UsePoison, 200);
    GET_VALUE_INT(Detoxification, 200);
    GET_VALUE_INT(AntiPoison, 200);
    ...
    GET_VALUE_INT(Knowledge, 200);
    GET_VALUE_INT(Morality, 100);
    GET_VALUE_INT(AttackWithPoison, 200);
    GET_VALUE_INT(Fame, 999);
    GET_VALUE_INT(IQ, 100);

    GET_VALUE_INT(HitRate, 100);
    GET_VALUE_INT(Dodge, 100);
    GET_VALUE_INT(CriticalRate, 100);

    GET_VALUE_INT(Exp, 999999);
