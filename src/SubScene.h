...
public:
    ...
    virtual void drawPositionInfo() override;
    ...
    void drawSwordSoulNPC(int ix, int iy, int px, int py, int h, std::vector<Color> color_v, std::vector<float> brighness_v);
    bool checkSwordSoulNPC(int x, int y);
