...
public:
    ...
    int HitRate, Dodge, CriticalRate;  // 命中率、闪避率、暴击率
    int PracticeItem;
    int ExpForItem;
...
public:
    ...
    struct ActionShowInfo
    {
        ...
        int ComboCount = 1;       // 连击次数（1=单次，2=二连击，3=三连击，5=五连击）
...
public:
    ...
    void addShowString(std::string text, ShowString::Color_t color = { 255, 255, 255, 255 }, int size = 36) { Show.ShowStrings.push_back({ text, color, size }); }
